...
# MAGIC %md
# MAGIC # Migration to databricks-feature-engineering
# MAGIC As of version 0.17.0, the databricks-feature-store package has been deprecated, and all its modules are now available in the databricks-feature-engineering package. It is recommended to migrate to databricks-feature-engineering for future-proofing your code.
