...
# MAGIC To run this demo, just select the cluster `dbdemos-feature-store-yang_yang` from the dropdown menu ([open cluster configuration](https://e2-demo-field-eng.cloud.databricks.com/#setting/clusters/1014-195209-dyh4drq5/configuration)). <br />
...
# DBTITLE 1,try this
fe.get_feature_serving_endpoint(feature_endpoint_name).query(lookup_keys)
